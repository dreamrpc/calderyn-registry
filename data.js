...
powers: [
  ...
  { char: "Ren Yamaguchi", status: "inactive", tier: "A", npc: true, power: "Cranial Combustion", expression: "Ren can build explosive pressure inside a target's skull or upper nervous system, causing sudden internal rupture. Rare, dangerous, and emotionally triggered. At age 11 he cannot fully control it — current output includes nosebleeds, migraines, burst blood vessels, pressure headaches, fainting, and small localised ruptures. Full lethal expression is possible and documented. Power is under active suppression protocol.", drawbacks: "Entirely emotionally triggered — distress, anger, or fear can activate it involuntarily. No formal control or training. Holder is 11 years old. Full lethal use is possible and terrifies both holder and family. Under continuous monitoring by parents and Calderyn medical staff. No operational deployment permitted." },
...
restrictedPowers: [
  {
    name: "Cranial Combustion",
    holder: "Ren Yamaguchi",
    reason: "Lethal at full expression. Power is emotionally triggered and currently uncontrolled in holder, age 11. Capable of causing nosebleeds, migraines, burst blood vessels, fainting, and localised internal rupture at present output. Full lethal expression is possible. No operational deployment permitted under any circumstances. Active parental and Calderyn medical supervision in place. Registry entry maintained for monitoring."
  },
],
