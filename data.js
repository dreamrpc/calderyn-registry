...
departments: [
     ...
     ───────────────────────────────────────────────────────────────── */
  {
    ...
    head: {
      ...
      char: "Eurydice Dreamwell",
      alias: "Dream",
      tier: "A",
      power: "Oneiric Perception · Somnolent Illusion",
      expression: "Dreamwell puts people to sleep. Not gently, not always, but consistently. A room she walks into goes quieter inside ten minutes if she wants it to. At surface level she settles panic, dims attention, eases someone over the edge of sleep without them noticing the push. At depth she builds dreamscapes around a single target or a small group. Full constructed rooms, corridors, conversations, stages a person walks through believing they are walking through anything else. The illusion bends what they see, what they hear, what they touch, what they feel emotionally, what they believe is happening in the moment. People come back from a Dreamwell dream sure they had a normal afternoon. Underneath that she runs a smaller kind of trick on the side. She calls it daydream tailoring and treats it like makeup. She can smooth a bruise off a student's face for a press appearance, soften the colour of tired eyes, slim the line of a jacket someone is still wearing, brighten or dim a person's complexion just enough that a camera reads them as someone slightly different. The work is surface only. It holds for as long as she is actively paying attention to it.",
