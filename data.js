...
faculty: [
     ...
     roster on the registry. */
  {
    ...
    rows: [
      ...
      { role: "Hound" },
      { role: "Hound" },
      { role: "Hound", char: "Sirius Strathe", stage: "", power: "Cellular Regeneration", expression: "Regenerates injuries/bodily damage. Limb/organs are replace/regrown at an accelerated rate, but speed is determined by damage/importance of organ. Immune to most, if not all diseases/toxins. ", drawbacks: "Goes into a catatonic state while regrowing vital organs, i.e heart, lungs, brain. CAN BE KILLED with enough damage to vital organs.", link: "https://roleplay.chat/profile.php?user=LichHound" }, // sub:fb7c4bcb
    ],
  },
],
...
powers: [
  ...
  { char: "Sirius Strathe", status: "faculty", power: "Cellular Regeneration", expression: "Regenerates injuries/bodily damage. Limb/organs are replace/regrown at an accelerated rate, but speed is determined by damage/importance of organ. Immune to most, if not all diseases/toxins. ", drawbacks: "Goes into a catatonic state while regrowing vital organs, i.e heart, lungs, brain. CAN BE KILLED with enough damage to vital organs.", link: "https://roleplay.chat/profile.php?user=LichHound" }, // sub:fb7c4bcb
