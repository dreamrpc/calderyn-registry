...
students: [
  ...
  { char: "Vittoria Delphine Malik", alias: "Crown", house: "saberis", year: "Sophomore", track: "hero", tier: "A-List", power: "Auric Transmutation · Kinetic Crystallization · Conductive Lacing · Thermal Sense · Treasury State", expression: "Vittoria possesses the ability to transmute matter into a living auric-gold state through touch, conductive spread, and focused activation. Unlike ordinary metallic conversion, her auric matter remains partially reactive.", drawbacks: "Emotional Destabilization, Conductive Vulnerability, Metabolic Strain, Escalation Risk, Treasury State Instability, Physical Contact Anxiety", link: "https://roleplay.chat/profile.php?user=Crown." },
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
auxFaculty: [
  { deptId: "media-arts", slotKind: "head", role: "Head of Media & Arts", char: "Professor Eurydice Lovecraft", alias: "Dream", tier: "A", power: "Oneiric Perception · Somnolent Illusion", expression: "Dream operates at the border between waking and sleeping. There is no visible light show, no dramatic visual signature. People near her describe a quality to the air: a warmth behind the eyes, a slowing of thought, the sense that the present moment has become slightly less urgent. She does not look like she is doing anything. That is part of how it works.\n\nSurface — She can settle drowsiness over a room, blur attention, soften panic, or ease a single target into sleep without their choosing it. The push is gentle enough that most people never notice they were pushed.\n\nDaydream — At a subtler register, she can reach into the pleasant drift of a half-waking state and rearrange its surface: the light seems warmer, a stranger feels familiar, a fear loosens slightly. Quiet, atmospheric, very hard to trace.\n\nDreamscape — At full depth, she constructs dreamscapes. Elaborate, consistent, sensory-complete realities: endless corridors, false conversations, impossible rooms, memory theatres, beautiful illusions with something terrible underneath. A person inside one believes they are walking through an ordinary afternoon, and tends to remember it that way after.\n\nOneiric Echoes — Eurydice believes dreams are a form of language. During natural sleep — especially after heavy use of her ability — she sometimes receives fragmented impressions of past events, hidden truths, or possible futures. These echoes are symbolic rather than literal: flooded rooms, cracked mirrors, burning film reels, faceless crowds, white moths, applause, blood on gloves, doors that should not exist. They do not provide clean answers and cannot be summoned on command, but they have been accurate often enough that she refuses to ignore them.", drawbacks: "Dreamscape vulnerability — At full depth, her physical body is entirely undefended. She is still, unresponsive, and unaware of the room around her for as long as she is inside a constructed dreamscape. Someone could simply walk up to her.\n\nDaydream is surface only — It does not change belief, override strong emotion, or hold against a person who is actively suspicious or resisting. It is soft pressure, not control.\n\nSleep resistance — She cannot force sleep on a target who is highly agitated, in severe pain, or chemically stimulated. Resistance grows proportionally with fear and adrenaline.\n\nEchoes are unreliable — Her Oneiric Echoes are symbolic, fragmented, and impossible to force. They may show a possible future rather than a guaranteed one. They can be misread, contaminated by her own fears, or distorted by recent dreamscape work. After deep use of her power, she may struggle to tell the difference between genuine warning, psychic afterimage, memory residue, and ordinary nightmare.\n\nReentry cost — Extended use causes disorientation and difficulty distinguishing her own present reality from constructed ones. After deep dreamscape work she needs time before she is safe to drive, make decisions, or be in any situation requiring precise judgment.", link: "https://www.roleplay.chat/profile.php?user=dream" }, // sub:f7faa2f9
...
powers: [
  ...
  { char: "Vittoria Delphine Malik", alias: "Crown", status: "student", tier: "A", power: "Auric Transmutation · Kinetic Crystallization · Conductive Lacing · Thermal Sense · Treasury State", expression: "Vittoria possesses the ability to transmute matter into a living auric-gold state through touch, conductive spread, and focused activation. Unlike ordinary metallic conversion, her auric matter remains partially reactive.", drawbacks: "Emotional Destabilization, Conductive Vulnerability, Metabolic Strain, Escalation Risk, Treasury State Instability, Physical Contact Anxiety", link: "https://roleplay.chat/profile.php?user=Crown." },
