...
students: [
  ...
  },
  {
    ...
    track: "hero",
    tier: "B-List",
    power: "Siren Hydroresonance — Pain-Driven Aquatic Command",
    expression: "Lyrica can control nearby water through resonance, breath, emotion, and damaged vocal projection. Water responds to her voice and presence, allowing her to shape it into whips, shields, waves, pressure bursts, dragging currents, steam clouds, and slick terrain. She can rapidly alter water temperature, boiling it into scalding attacks or steam screens, cooling it into icy slush, or freezing thin surfaces into brittle barriers. Her ability becomes dramatically stronger near bodies of water such as pools, rivers, lakes, harbours, heavy rain, and the Thames. Around large water sources, her range, force, and precision increase, making her far more dangerous.",
    drawbacks: "Lyrica's vocal cords were permanently damaged in a supe-related attack, making vocal power use painful and unstable. Speaking hurts after prolonged use, singing burns, and screaming risks blood, collapse, or voice loss. She cannot create endless water from nothing and is strongest when drawing from existing sources such as rain, pipes, bottles, fountains, pools, rivers, or humidity. Boiling or freezing water costs more energy than simply moving it, and large-scale temperature changes exhaust her quickly. Dry environments, dehydration, sound suppression, throat restraints, gags, panic, electric attacks, and lack of nearby water severely limit her. Near massive bodies of water, her power becomes stronger but more volatile.",
...
powers: [
  ...
  },
  {
    ...
    tier: "B",
    power: "Siren Hydroresonance — Pain-Driven Aquatic Command",
    expression: "Resonance-based water control shaped by voice, breath, and emotion. Shapes water into whips, shields, waves, pressure bursts, dragging currents, steam clouds, and slick terrain. Rapid temperature shifts let her boil water into scalding attacks or steam screens, cool it into icy slush, or freeze thin surfaces into brittle barriers. Power scales dramatically near pools, rivers, lakes, harbours, heavy rain, and the Thames — range, force, and precision increase around large water sources.",
    drawbacks: "Permanently damaged vocal cords from a prior supe-related attack — speaking hurts after prolonged use, singing burns, screaming risks blood, collapse, and voice loss. Cannot create endless water from nothing; strongest when drawing from existing sources (rain, pipes, bottles, fountains, pools, rivers, humidity). Boiling and freezing cost more than moving water, and large-scale temperature shifts exhaust her quickly. Limited by dry environments, dehydration, sound suppression, throat restraints, gags, panic, and electric attacks. Near massive bodies of water, her power is stronger but more volatile.",
    link: "https://roleplay.chat/profile.php?user=lyrica"
  },
  {
    status: "student",
