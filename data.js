...
students: [
  ...
  { char: "Viviane Yamaguchi", alias: "VEIN", house: "grimere", year: "Freshman", track: "sidekick", tier: "B-List", power: "Vital Manipulation · X-Ray Vision", expression: "Viviane can sense and control living vital systems at range — heartbeat, blood flow, breathing, nerve signals, muscle tension, blood pressure, pain response, organ stress, and tissue repair. Her touch or focused attention allows her to stabilise injuries, alter circulatory pressure, or override motor functions entirely. She also possesses natural X-Ray vision, allowing her to see through surfaces and scan bone, muscle, organ, and blood-flow layers. This ability is regulated by her Vitrex Diagnostic Goggles, which filter her visual input across multiple diagnostic modes (bone scan, organ scan, muscle scan, blood-flow, foreign object detection, power-damage detection). Without the goggles, her x-ray sight runs unfiltered, causing sensory overload.", drawbacks: "Requires sustained focus — loss of concentration breaks the effect. Range reduces precision significantly. Crowds and busy environments overwhelm her senses. Physical barriers and armour interfere with vital manipulation. Complex tissue repair is far harder and slower than causing harm. Unfiltered x-ray vision causes migraines, nausea, eye strain, nosebleeds, and sensory overload — requires Vitrex Goggles to function safely. Cannot resurrect the dead. Has a deep fear of losing control over her own power.", link: "https://roleplay.chat/profile.php?user=vein" }, // sub:28edfc1f
...
powers: [
  ...
  { char: "Viviane Yamaguchi", alias: "VEIN", status: "student", tier: "B", power: "Vital Manipulation · X-Ray Vision", expression: "Viviane can sense and control living vital systems at range — heartbeat, blood flow, breathing, nerve signals, muscle tension, blood pressure, pain response, organ stress, and tissue repair. Her touch or focused attention allows her to stabilise injuries, alter circulatory pressure, or override motor functions entirely. She also possesses natural X-Ray vision, allowing her to see through surfaces and scan bone, muscle, organ, and blood-flow layers. This ability is regulated by her Vitrex Diagnostic Goggles, which filter her visual input across multiple diagnostic modes (bone scan, organ scan, muscle scan, blood-flow, foreign object detection, power-damage detection). Without the goggles, her x-ray sight runs unfiltered, causing sensory overload.", drawbacks: "Requires sustained focus — loss of concentration breaks the effect. Range reduces precision significantly. Crowds and busy environments overwhelm her senses. Physical barriers and armour interfere with vital manipulation. Complex tissue repair is far harder and slower than causing harm. Unfiltered x-ray vision causes migraines, nausea, eye strain, nosebleeds, and sensory overload — requires Vitrex Goggles to function safely. Cannot resurrect the dead. Has a deep fear of losing control over her own power.", link: "https://roleplay.chat/profile.php?user=vein" }, // sub:28edfc1f
  { char: "Layla Armstrong", alias: "Hexashift", status: "student", tier: "B", power: "Limb Extension, Teleportation, Superhuman Strength", expression: "Sheeva [Mortal Kombat] x Dhalsim [Street Fighter]", drawbacks: "Can only stretch so far before limbs tear. Can't teleport long distances and can only teleport self.", link: "https://roleplay.chat/profile.php?user=Layla_" }, // sub:6f29a7e1
  { char: "Ren Yamaguchi", status: "inactive", tier: "A", npc: true, power: "Pressure Bloom", expression: "Ren builds invisible pressure inside living tissue — particularly around the skull, brain, and blood vessels. In theory it could cause catastrophic internal rupture, but Ren actively tries to prevent that. Because the pressure frequently rebounds inside his own body, he experiences severe migraines, nosebleeds, dizziness, light sensitivity, and fainting spells. His ability is treated as a dangerous medical condition more than a weapon.", drawbacks: "Pressure rebounds into his own body as often as it targets others — causing chronic migraines, nosebleeds, dizziness, light sensitivity, and fainting. Emotionally influenced; stress worsens both the rebound and the risk of uncontrolled external expression. Age 11, no training, under continuous parental and Calderyn medical supervision. No operational deployment permitted." },
...
restrictedPowers: [
  {
    ...
    reason: "Capability for catastrophic internal rupture in third parties exists at full expression, though holder actively suppresses use. Power rebounds into holder's own body — treated as a dangerous medical condition rather than a weapon. Holder is age 11, under continuous parental and Calderyn medical supervision. No operational deployment permitted under any circumstances. Registry entry maintained for monitoring."
  },
],
