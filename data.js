...
rules: [
  // Conduct (01-05) — how we treat each other in and out of character.
  { n: "01", category: "conduct", title: "Respect everyone.",                     body: "Treat all members with respect in and out of character. Your character can be terrible. You cannot. Harassment, bigotry, or targeted behaviour toward another player is grounds for immediate removal." },
  { n: "02", category: "conduct", title: "No godmodding or powerplaying.",        body: "You do not control another player's character without their explicit consent. This includes dictating outcomes of actions, overriding another character's reactions, or writing their responses for them." },
  { n: "03", category: "conduct", title: "Keep OOC conflict out of IC spaces.",   body: "If you have a problem with another player, take it to admin privately. Do not play out real grievances through your characters. Do not use IC spaces to publicly address OOC issues." },
  { n: "04", category: "conduct", title: "Activity.",                              body: "If you go inactive without notice for more than 30 days, your character slots may be reopened. Let admin know if you need a hiatus — we will hold your spots. Silence will not be assumed to be a hiatus." },
  { n: "05", category: "conduct", title: "Admin decisions are final.",             body: "Disagreements with admin decisions should be raised calmly and in private. Public disputes, callouts, or attempts to rally other players against a ruling will not be entertained and may result in removal." },
  // Casting (06-09) — submissions, queueing, what gets through review.
  { n: "06", category: "casting", title: "Check the masterlist before applying.", body: "All character concepts must be checked against the registry before submission. Duplicate power expressions and naming conflicts will be caught at review — checking first saves everyone time." },
  { n: "07", category: "casting", title: "Three-day cooldown between applications.", body: "There is no cap on how many characters you can play, but the room is run by a single mod. To keep applications reviewable, please wait three days after submitting one character application before submitting your next. Patience here keeps the queue moving and the reviews thorough." },
  { n: "08", category: "casting", title: "Power applications require approval.",   body: "All powers must be registered in the Powers tab before play begins. A-List applications require a separate conversation with admin before submission. Do not play an unregistered ability." },
    { n: "09", category: "casting", title: "Cradle bands are hard limits.",     body: "A character's age must fall inside the age range of their Cradle phase — Cradle III runs roughly ages 0–26, Cradle II 31–46, and Cradle I 51–58. Powers track the Cradle a character was born into, so anyone with abilities is expected to sit in the band that matches their Cradle. The Dean and Vale are the only Cradle I characters above 46. Paragon is a Cradle II character (age 31–46) who received the Cradle I injection — a Cradle II body with Cradle I powers, which is why he sits in the 31–46 band even though his power profile reads as Cradle I. Submissions outside those bands will not be accepted — please read the lore (start with The Programme) before submitting." },  
],
