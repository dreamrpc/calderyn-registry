...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
auxFaculty: [
  { deptId: "media-arts", slotKind: "head", role: "Head of Media & Arts", char: "Professor Eurydice Lovecraft", alias: "Dream", tier: "A", power: "Oneiric Perception · Somnolent Illusion", expression: "Dream operates at the border between waking and sleeping. There is no visible light show, no dramatic visual signature. People near her describe a quality to the air: a warmth behind the eyes, a slowing of thought, the sense that the present moment has become slightly less urgent. She does not look like she is doing anything. That is part of how it works.\n\nAt surface level, she can settle drowsiness over a room, blur attention, soften panic, or ease a single target into sleep without their choosing it. At a subtler register, she can reach into the pleasant drift of a half-waking state and rearrange its surface: the light seems warmer, a stranger feels familiar, a fear loosens slightly. A daydream effect. Gentle, quiet, and very hard to trace.\n\nAt full depth, she constructs dreamscapes. Elaborate, consistent, sensory-complete realities: endless corridors, false conversations, impossible rooms, memory theatres, beautiful illusions with something terrible underneath. A person inside one i", drawbacks: "At full depth, her physical body is entirely vulnerable. She is still, unresponsive, and undefended for as long as she is inside a constructed dreamscape. She cannot maintain awareness of the real world while working at that level. Someone could simply walk up to her.\n\nThe daydream effect is surface only. It does not change belief, override strong emotion, or hold against a person who is actively suspicious or resisting. It is soft pressure, not control.\n\nShe cannot force sleep on a target who is highly agitated, in severe pain, or chemically stimulated. Resistance grows proportionally with fear and adrenaline.\n\nExtended use causes disorientation and a difficulty distinguishing her own present reality from constructed ones. After deep dreamscape work, she needs time before she is safe to drive, make decisions, or be in a situation requiring precise judgment.", link: "https://www.roleplay.chat/profile.php?user=dream" }, // sub:f7faa2f9
