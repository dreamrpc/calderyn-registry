...
faculty: [
     ...
     roster on the registry. */
  {
    ...
    rows: [
      ...
      { role: "Hound" },
      { role: "Hound" },
      { role: "Hound", char: "Sirius Strathe", stage: "Lich", tier: "A", power: "Cellular Regeneration", expression: "Regenerates injuries/bodily damage. Limb/organs are replace/regrown at an accelerated rate, but speed is determined by damage/importance of organ. Immune to most, if not all diseases/toxins. ", drawbacks: "Goes into a catatonic state while regrowing vital organs, i.e heart, lungs, brain. CAN BE KILLED with enough damage to vital organs.", link: "https://roleplay.chat/profile.php?user=LichHound" }, // sub:fb7c4bcb
      { role: "Hound", char: "Emma Willows", stage: "Wire", tier: "C", power: "Filament Generation & Manipulation, Adaptive Filament States, Filament Affinity, Enhanced Physical Condition", expression: "Filament Generation & Manipulation\nWire possesses the ability to generate and control an advanced superhuman filament from her body. These strands can vary dramatically in thickness, density, flexibility, and sharpness, allowing her to adapt them to nearly any situation. A filament can be as delicate as spider silk one moment and capable of restraining superhuman opponents the next. Unlike simple wire creation, Emma's true gift lies in her extraordinary control over the material, allowing her to weave, layer, reinforce, and manipulate thousands of strands with remarkable precision.\n\n(Full: https://docs.google.com/document/d/168dsbaM1R7fC6wbSKCc5kB9zP_hDM4TRGxe4rBryev8/edit?usp=sharing)", drawbacks: "Human Vulnerability, Preparation Dependency, Cognitive Strain, Sensory Feedback Overload, Environmental Hazards, Resource Management, Reluctance Toward Lethal Force, Difficulty Trusting Others, Unresolved Grief, Protective Instincts, The Velora Vulnerability, Physical Limitations", link: "https://roleplay.chat/profile.php?user=Wire" }, // sub:dad1086e
    ],
  },
],
...
auxFaculty: [
  ...
  { deptId: "history-doctrine", slotKind: "head", role: "Head of History & Doctrine", char: "Godric Vale", alias: "Time Lord", tier: "A", power: "Temporal Displacement (Suppressed), Chrono Shift, Temporal Perception, Somnolence Manipulation, Temporal Echoes, FlightEnhanced Physical Attributes, ", expression: "Temporal Displacement (Suppressed)\nGodric's most defining ability once allowed him to travel both backward and forward through time, physically entering different points along the timeline while retaining his memories and awareness. Originally developed as one of the primary successes of the Cradle I STG-7 program, this power made him one of STRATA's most valuable strategic assets, capable of observing, influencing, and occasionally altering historical events under strict authorization. Over the course of decades, he performed numerous sanctioned temporal interventions, alongside a handful of unsanctioned attempts to quietly improve lives where he believed history allowed compassion without catastrophe. \n\n(Full: https://docs.google.com/document/d/1SgctK6fMth_eqzNY1O_3tE3nzEkV-eCuOvIP5M0OyY0/edit?usp=sharing)", drawbacks: "Temporal Suppression, Temporal Strain, Butterfly Burden, Finite Durability, Psychological Weight, Compassion Before Expedience, Temporal Intrusions", link: "https://roleplay.chat/profile.php?user=Time+Lord" }, // sub:5ee4222d
...
outside: [
  ...
  },
  {
    ...
    orgs: [
      ...
      {
        name: "Respiro",
        type: "Recovery Studio & Spa",
        note: "Discreet recovery studio and spa off the Greenwich riverside, owned and run by Emilio Marchetti. Physical therapy, sports and deep-tissue massage, and full spa treatments by day; after hours the books fill with STRATA contractors who need putting back together and would rather it stayed off a file. Good staff, low light, and nobody asks who the late appointments are.",
        roles: [
...
powers: [
  ...
  { char: "Emma Willows", alias: "Wire", status: "faculty", tier: "C", power: "Filament Generation & Manipulation, Adaptive Filament States, Filament Affinity, Enhanced Physical Condition", expression: "Filament Generation & Manipulation\nWire possesses the ability to generate and control an advanced superhuman filament from her body. These strands can vary dramatically in thickness, density, flexibility, and sharpness, allowing her to adapt them to nearly any situation. A filament can be as delicate as spider silk one moment and capable of restraining superhuman opponents the next. Unlike simple wire creation, Emma's true gift lies in her extraordinary control over the material, allowing her to weave, layer, reinforce, and manipulate thousands of strands with remarkable precision.\n\n(Full: https://docs.google.com/document/d/168dsbaM1R7fC6wbSKCc5kB9zP_hDM4TRGxe4rBryev8/edit?usp=sharing)", drawbacks: "Human Vulnerability, Preparation Dependency, Cognitive Strain, Sensory Feedback Overload, Environmental Hazards, Resource Management, Reluctance Toward Lethal Force, Difficulty Trusting Others, Unresolved Grief, Protective Instincts, The Velora Vulnerability, Physical Limitations", link: "https://roleplay.chat/profile.php?user=Wire" }, // sub:dad1086e
  { char: "Godric Vale", alias: "Time Lord", status: "faculty", power: "Temporal Displacement (Suppressed), Chrono Shift, Temporal Perception, Somnolence Manipulation, Temporal Echoes, FlightEnhanced Physical Attributes, ", expression: "Temporal Displacement (Suppressed)\nGodric's most defining ability once allowed him to travel both backward and forward through time, physically entering different points along the timeline while retaining his memories and awareness. Originally developed as one of the primary successes of the Cradle I STG-7 program, this power made him one of STRATA's most valuable strategic assets, capable of observing, influencing, and occasionally altering historical events under strict authorization. Over the course of decades, he performed numerous sanctioned temporal interventions, alongside a handful of unsanctioned attempts to quietly improve lives where he believed history allowed compassion without catastrophe. \n\n(Full: https://docs.google.com/document/d/1SgctK6fMth_eqzNY1O_3tE3nzEkV-eCuOvIP5M0OyY0/edit?usp=sharing)", drawbacks: "Temporal Suppression, Temporal Strain, Butterfly Burden, Finite Durability, Psychological Weight, Compassion Before Expedience, Temporal Intrusions", link: "https://roleplay.chat/profile.php?user=Time+Lord" }, // sub:5ee4222d
...
clubs: [
  ...
  },
  {
    ...
    groups: [
      ...
      { label: "Swimmers", roles: ["Freestyle", "Backstroke", "Breaststroke", "Butterfly", "Individual Medley"] },
      { label: "Reserves", roles: ["Alternate Swimmer"] },
    ],
    positions: [
      { pos: "Captain", group: "leadership" },
      { pos: "Freestyle", group: "swimmers" }, { pos: "Freestyle", group: "swimmers" },
      { pos: "Backstroke", group: "swimmers" }, { pos: "Backstroke", group: "swimmers" },
      { pos: "Breaststroke", group: "swimmers" }, { pos: "Breaststroke", group: "swimmers" },
      { pos: "Butterfly", group: "swimmers" }, { pos: "Butterfly", group: "swimmers" },
      { pos: "Individual Medley", group: "swimmers" },
      { pos: "Alternate Swimmer", group: "reserves" }, { pos: "Alternate Swimmer", group: "reserves" },
    ],
  },
  {
    name: "Supe Athletics",
    ...
    groups: [
      { label: "Leadership", roles: ["Captain"] },
      { label: "Track", roles: ["Sprints", "Distance", "Hurdles"] },
      { label: "Field", roles: ["Jumps", "Throws"] },
      { label: "Reserves", roles: ["Alternate Athlete"] },
    ],
    positions: [
      { pos: "Captain", group: "leadership" },
      { pos: "Sprints", group: "track" }, { pos: "Sprints", group: "track" },
      { pos: "Distance", group: "track" }, { pos: "Distance", group: "track" },
      { pos: "Hurdles", group: "track" },
      { pos: "Jumps", group: "field" }, { pos: "Jumps", group: "field" },
      { pos: "Throws", group: "field" }, { pos: "Throws", group: "field" },
      { pos: "Alternate Athlete", group: "reserves" }, { pos: "Alternate Athlete", group: "reserves" },
    ],
  },
  {
    name: "Gymnastics",
  ...
  },
  {
    ...
    groups: [
      { label: "Leadership", roles: ["President", "Project Lead"] },
      { label: "Build Team", roles: ["Fabricator", "Systems & Power", "Software"] },
      { label: "Members", roles: ["Member"] },
    ],
    positions: [
  ...
  },
  {
    ...
    groups: [
      { label: "Leadership", roles: ["Head of Kitchen"] },
      { label: "Kitchen", roles: ["Line Cook", "Baker"] },
      { label: "Members", roles: ["Member"] },
    ],
    positions: [
  ...
  },
  {
    ...
    groups: [
      { label: "Leadership", roles: ["Captain"] },
      { label: "Boards", roles: ["Board One", "Board Two", "Board Three", "Board Four"] },
      { label: "Members", roles: ["Member"] },
    ],
    positions: [
      { pos: "Captain", group: "leadership" },
      { pos: "Board One", group: "boards" },
      { pos: "Board Two", group: "boards" },
      { pos: "Board Three", group: "boards" },
      { pos: "Board Four", group: "boards" },
      { pos: "Member", group: "members" }, { pos: "Member", group: "members" },
      { pos: "Member", group: "members" }, { pos: "Member", group: "members" },
    ],
  },
  ...
  },
  {
    ...
    groups: [
      { label: "The Ring", roles: ["Ringrunner"] },
      { label: "Contenders", roles: ["Contender"] },
    ],
    positions: [
...
mapLocations: [
  ...
  { id: "skate-ramp", district: "academic", n: "A18",
    ...
    desc: "A half-pipe and a pair of grind rails that rose out of the main courtyard outside the Refectory more or less overnight — Moni Li compressed the whole thing straight up out of the existing flagstone with his geokinesis, no concrete poured and no work order filed. He built it for Katniss and Dex to skate, but word travelled fast, and on any dry afternoon it pulls avid skaters from every house and a few who don't even go here. It has never been school-sanctioned — it sits on no facilities plan and was never approved. Student Body President Montgomery 'Upchuck' Farthing III brought a motion to have it torn out and lost the Student Council vote on the record, so the ramp stays until someone with more than a gavel decides otherwise.",
  ...
  { id: "respiro", district: "outside", n: "X9",
    name: "Respiro",
    sub: "Recovery studio & spa · riverside",
    desc: "Emilio Marchetti's recovery studio and spa on the Greenwich riverside, between the market and the water. The name is Italian for breath. Warm light, low jazz, eucalyptus and good coffee. Physical therapy, massage, and spa treatments by day; after dark, a quiet list of STRATA contractors being put back together off the record. The card in the window says recovery, physio, and sports massage. It doesn't mention what else the owner's hands can do.",
    tags: ["Recovery & spa", "Physical therapy", "STRATA-adjacent"],
  },
],
