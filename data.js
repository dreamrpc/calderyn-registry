...
mapLocations: [
  ...
  /* ═══ HOUSE RESIDENCES ════════════════════════════════════════════
     ...
     Housing Policy (no `house`) is a residence-wide note; the shared
     communal spaces now live in Campus Commons. */
  ...
  // ── HOUSE POLICY — residence-wide, not tied to one house ──
  { id: "residential-policy", district: "residence", n: "R·1",
    name: "Housing Policy",
  ...
  // ── SHARED RESIDENTIAL — quad, kitchen, laundry & garden, open to all four houses ──
